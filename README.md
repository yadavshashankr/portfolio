...
These visuals showcase the app's complete overhaul: from XML, RxJava, MVVM, Java, and multi-threading to Jetpack Compose, Flows (mainly StateFlow and CallbackFlow), MVVM Clean, Kotlin, Coroutines, and TDD with Unit, Instrumentation, and UI testing. Github Actions handle CI/CD.
  ...
  Landing   |   Dashboard                           
:----------:|:-------------:
<img src="/assets/vid/spendlink/Landing.gif" width=75% height=75%> | <img src="assets/vid/spendlink/Dashboard.gif" width=75% height=75%>
...
:-------------------------:|:-------------------------:
<img src="/assets/vid/spendlink/Login_With_Credentials.gif" width=75% height=75%> | <img src="assets/vid/spendlink/Login_With_Biometrics.gif" width=75% height=75%>
